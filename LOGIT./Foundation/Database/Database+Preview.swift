...
extension Database {
    ...
    static var preview: Database {
        ...
        let tricepsExtensions = database.newExercise(name: "Triceps Extensions", muscleGroup: .arms)
        ...
        let bicepsCurls = database.newExercise(name: "Biceps Curls", muscleGroup: .arms)

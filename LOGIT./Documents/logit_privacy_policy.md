_Last updated October 13, 2023_

This privacy notice for **LOGIT** ("we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:
...
- **Do we process any sensitive personal information?** We may process sensitive personal information when necessary with your consent or as otherwise permitted by applicable law. [Learn more about sensitive information we process.](#WHAT-INFORMATION-DO-WE-COLLECT?)
...
- **How do you exercise your rights?** The easiest way to exercise your rights is by submitting a _data subject access request_, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
...
11. [ON-DEVICE PHOTO PROCESSING AND DATA TRANSMISSION ADVISORY](#ON-DEVICE-PHOTO-PROCESSING-AND-DATA-TRANSMISSION-ADVISORY)
...
- **Mobile Device Access.** We may request access or permission to certain features from your mobile device, including your mobile device's camera, storage, photo library, and other features. If you wish to change our access or permissions, you may do so in your device's settings.
...
## 11. ON-DEVICE PHOTO PROCESSING AND DATA TRANSMISSION ADVISORY

To generate a workout or template from a photo, all photo processing is conducted exclusively on the device. This ensures that the photo remains confined to your device and is not shared or accessed externally. Only the text extracted from such photos is transmitted to OpenAI's chat completion API to interpret workout details. Users are advised to avoid capturing images of sensitive or confidential content that they do not wish to share with OpenAI's models.
